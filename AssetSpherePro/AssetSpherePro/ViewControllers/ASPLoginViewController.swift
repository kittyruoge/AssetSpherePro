...
final class ASPLoginViewController: ASPBaseViewController {
    ...
    func getDazhutouValue() -> Int {
        return UserDefaults.standard.integer(forKey: "dazhutouValue")  // 默认返回 0
    }
    ...
    @objc private func asp_loginTapped() {
        ...
        let dianzi = ["keyae", "112", "test", "zhutou"]
        let erziset = dianzi[getDazhutouValue()]
